...
from modules.sensors.sds011_sensor import SDS011Sensor
...
def init_sensor():
    ...
    try:
        sensor = SDS011Sensor()
        publisher = MQTTPublisher(topic=os.getenv("MQTT_TOPIC", "sensors/sds011"))
        app.logger.info("SDS011 sensor initialized")
